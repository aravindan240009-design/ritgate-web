  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-800 space-y-3">
      ...
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-full bg-slate-200 dark:bg-slate-700 skeleton" />
        <div className="flex-1 space-y-2">
          <div className="h-3.5 bg-slate-200 dark:bg-slate-700 rounded-lg w-3/5 skeleton" />
          <div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-lg w-2/5 skeleton" />
        </div>
        <div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-lg w-12 skeleton" />
      </div>

      {/* Info box */}
      <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-3.5 space-y-2.5">
        <div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-lg w-11/12 skeleton" />
        <div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-lg w-3/5 skeleton" />
      </div>

      {/* Status pill */}
      <div className="h-7 bg-slate-200 dark:bg-slate-700 rounded-full w-20 skeleton" />
    </div>
  );
}
