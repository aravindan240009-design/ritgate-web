...
export default function ProfilePage({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC] dark:bg-slate-950 overflow-hidden lg:h-[calc(100vh-142px)] lg:min-h-0 lg:bg-transparent">
      {!isDesktop && (
        <header
      ...
      <TopRefreshControl refreshing={refreshing} onRefresh={handleRefresh}>
        <div className="px-5 pt-6 pb-32 min-h-[calc(100vh-100px)] lg:mx-auto lg:grid lg:h-full lg:min-h-0 lg:w-full lg:max-w-[1180px] lg:grid-cols-[340px_minmax(0,1fr)] lg:grid-rows-[82px_auto_1fr] lg:items-stretch lg:gap-x-7 lg:gap-y-5 lg:overflow-hidden lg:px-0 lg:pt-0 lg:pb-0 xl:max-w-[1280px] xl:grid-cols-[360px_minmax(0,1fr)] xl:gap-x-8">
          <div className="flex flex-col items-center mb-8 lg:mb-0 lg:row-span-3 lg:self-stretch lg:bg-white/78 lg:dark:bg-slate-900/80 lg:border lg:border-white/60 lg:dark:border-slate-800/80 lg:rounded-[18px] lg:px-7 lg:py-8 lg:shadow-[0_24px_60px_-38px_rgba(15,23,42,0.62)] lg:backdrop-blur-2xl lg:w-full lg:overflow-hidden">
            <div className="relative mb-5">
              <div className="w-[110px] h-[110px] rounded-full border-2 border-blue-700 p-1 flex items-center justify-center bg-white dark:bg-slate-900 shadow-xl shadow-blue-100 lg:h-[120px] lg:w-[120px] lg:border-[3px]">
                {profileImage ? (
                  <img
                    src={profileImage}
                    alt={userName}
                  ...
                  <div className="w-full h-full rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-[38px] font-black text-blue-700 lg:text-[42px]">
                    {initials}
                  </div>
                )}
              </div>
            </div>
            <h2 className="text-[21px] font-black text-slate-900 dark:text-white uppercase tracking-tight mb-1 text-center lg:text-[25px]">
              {userName}
            </h2>
            ...
            <div className="hidden lg:block w-full mt-7 pt-6 border-t border-slate-100 dark:border-slate-800">
            ...
            {[
              ...
              <React.Fragment key={stat.label}>
                <div className="flex flex-col items-center justify-center flex-1">
                  <span
                    className={cn("text-[22px] font-black mb-0.5 lg:text-[23px]", stat.color)}
                  >
                    {stat.value}
                  </span>
          ...
          <div className="mb-8 lg:mb-0 lg:col-start-2 lg:row-start-2">
            ...
            <div className="lg:w-full [&>*]:lg:rounded-[18px]">
              <ThemePresetSelector />
            </div>
          </div>
          ...
          <div className="mb-10 lg:mb-0 lg:col-start-2 lg:row-start-3 lg:min-h-0">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[24px] lg:rounded-[18px] lg:w-full border border-slate-100 dark:border-slate-800 shadow-[0_18px_42px_-30px_rgba(15,23,42,0.5)] overflow-hidden divide-y divide-slate-50 dark:divide-slate-800/50 lg:bg-white/78 lg:border-white/60 lg:backdrop-blur-2xl">
              {menuItems.map((item) => (
                <div
                  key={item.label}
                  className="p-5 lg:min-h-[68px] lg:px-5 lg:py-3 flex items-center gap-4"
                >
                  <div
                    className={cn(
